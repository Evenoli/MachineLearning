function [ Results, opti_params ] = OptimiseNNParamsGDM()
...
%Parameter: learning rate (lr)
    ...
    for j = 1:CROSS_VALIDATION_NUM
        ...
        Results{j} = OptimiseGDMHelper(j, trainx, trainy, validationx, validationy,...
            num_layers, neurons_per_layer, learningRate, momentum, N_EPOCHS );
        
        fold_start = fold_end+1;
    end

    opti_params = getOptimalParametersGDM(Results);
end
